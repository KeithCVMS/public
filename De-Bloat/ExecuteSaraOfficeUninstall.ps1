...
#
# modified Keith Hay
#	1. commented out the validation check for a -script switch as no such switch exists
#		it is the -S switch
#	2. script is set to do a complete Office uninstall for all versions
#
#****************************************************************************************************
#
...
#
# Example: $SaraScenarioArgument = "-S OfficeScrubScenario -AcceptEula -OfficeVersion All"
#			"-S OfficeScrubScenario -Script -AcceptEula" 
#			"-S TeamsAddinScenario -Script -AcceptEula -CloseOutlook"
#
$SaraScenarioArgument = "-S OfficeScrubScenario -AcceptEula -OfficeVersion All"
#
